    ...
    private function buildBtrWiseReport(Request $request)
    {
        ...
        foreach ($acceptanceItems as $ai) {
            ...
            $btrGroups[$btrNo][$productId]['entries'][] = [
                ...
                'do_no' => $ai->voucher?->do_no ?? '-',
                'do_date' => $ai->voucher?->do_date ? date('d-m-Y', strtotime($ai->voucher->do_date)) : '-',
        ...
        foreach ($receiptItems as $ri) {
            ...
            $btrGroups[$btrNo][$productId]['entries'][] = [
                ...
                'do_no' => $ri->receipt?->do_no ?? '-',
                'do_date' => $ri->receipt?->do_date ? date('d-m-Y', strtotime($ri->receipt->do_date)) : '-',
