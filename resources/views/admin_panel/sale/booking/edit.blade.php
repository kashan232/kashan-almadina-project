                    ...
                    <div class="p-3 border-end" style="min-width: 350px;">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <input type="text" class="form-control me-2" name="Invoice_no" style="width: 100px;"
                                value="{{ $booking->invoice_no ?? $nextInvoiceNumber }}" readonly>
                            ...
                            <select class="form-select js-example-basic-single" name="customer" id="customerSelect">
                                ...
                                @foreach ($customers as $customer)
                                    <option value="{{ $customer->id }}"
                                        {{ isset($booking) && $booking->customer_id == $customer->id ? 'selected' : '' }}>
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <select id="customerType" name="customerType" class="form-select me-2" style="width: 120px;">
                                <option value="">{{ $booking->sub_customer ?? 'Sub Customer' }}</option>
                            </select>

                            <input type="text" id="filerType" name="filerType" class="form-control"
                                value="{{ $booking->filer_type ?? '' }}" placeholder="Filer Type">
                        </div>
...
<tr>
    ...
    <td><input type="text" class="form-control stock text-danger text-center" value="{{ $item->stock }}" readonly></td>
    <td><input type="text" class="form-control text-end price" value="{{ $item->price_level }}" readonly></td>
    ...
    <td><input type="text" class="form-control text-end sales-amount" value="{{ $item->amount }}" readonly></td>
</tr>
@endforeach
                                    ...
                                    <tr>
                                        <td> <select class="form-select warehouse form-control" name="warehouse_name[]">
                                                <option value="">Select</option>
                                                @foreach ($warehouses as $wh)
                                                    <option value="{{ $wh->id }}">{{ $wh->warehouse_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </td>
                                        ...
                                        <td><input type="text" class="form-control stock text-danger text-center"
                                                name="stock[]" readonly></td>
                                        <td><input type="text" class="form-control text-end price" name="price[]"
                                                readonly></td>
                                        <td><input type="text" class="form-control text-end sales-price"
                                                name="sales-price[]" value="0"></td>
                                        <td><input type="text" class="form-control text-end sales-qty" value="0"
                                                name="sales-qty[]"></td>
                                        <td><input type="text" class="form-control text-end retail-price"
                                                name="retail-price[]" value="0"></td>
                                        <td><input type="text" class="form-control text-end discount-percent"
                                                name="discount-percent[]" value="0"></td>
                                        <td><input type="text" class="form-control text-end discount-amount"
                                                name="discount-amount[]" value="0"></td>
                                        <td><input type="text" class="form-control text-end sales-amount"
                                                name="sales-amount[]" value="0" readonly></td>
                ...
                <div class="d-flex justify-content-between p-3 border-bottom">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            ...
                            <input type="text" class="form-control text-end me-2" style="width: 70px;" value="{{ $booking->sub_total1 ?? 0 }}"
                                name="subTotal1" id="subTotal1">
                            <input type="text" class="form-control text-end me-2" style="width: 70px;" value="{{ $booking->sub_total2 ?? 0 }}"
                                name="subTotal2" id="subTotal2">
                            <input type="text" class="form-control text-end fw-bold text-primary"
                                style="width: 150px;" value="{{ $booking->sub_total2 ?? 0 }}">
                        </div>
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            <label class="form-label me-2">Discount:</label>
                            <input type="text" class="form-control text-end me-2" style="width: 120px;"
                                value="{{ $booking->discount_percent  ?? 0 }}" name="discountPercent" id="discountPercent">
                            <input type="text" class="form-control text-end" style="width: 150px;" value="0">
                        </div>
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            <label class="form-label me-2">Discount Rs:</label>
                            <input type="text" class="form-control text-end" style="width: 150px;" value="{{ $booking->discount_amount  ?? 0 }}"
                        ...
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            ...
                            <input type="text" class="form-control text-end text-danger" style="width: 150px;"
                                value="{{ $booking->previous_balance ?? 0 }}" id="previousBalance" name="previousBalance">
                        </div>
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            <label class="form-label fw-bold text-primary me-2">Total Balance:</label>
                            <input type="text"
                                class="form-control text-end fw-bold text-primary bg-info-subtle border-primary"
                                style="width: 150px;" value="{{ $booking->total_balance ?? 0 }}" id="totalBalance" name="totalBalance">
                        </div>
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            <label class="form-label me-2">Receipt Voucher:</label>
                            <input type="text" class="form-control me-2" style="width: 250px;" value="{{ $booking->receipt1 ?? 0 }}">
                            <input type="text" class="form-control text-end me-2" style="width: 90px;"
                                name="receipt1"value="{{ $booking->receipt1 ?? 0 }}" id="receipt1">
                            <input type="text" class="form-control text-end" style="width: 70px;" value="{{ $booking->receipt2 ?? 0 }}"
                        ...
                        <div class="d-flex justify-content-end align-items-center mb-1">
                            ...
                            <input type="text" class="form-control text-end me-2" style="width: 150px;"
                                value="{{ $booking->receipt2 ?? 0 }}" name="finalBalance1" id="finalBalance1">
                            <input type="text" class="form-control text-end" style="width: 150px;"  value="{{ $booking->final_balance2 ?? 0 }}"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $productSelect.append('<option value="' + value.id + '">' + value
                                .name + '</option>');
                        });
                    }
                });
