...
@endif
    ...
    <input type="text" class="form-control" name="Invoice_main" placeholder="Enter manual invoice">
</div>
...
<!-- ✅ Select2 CSS -->
    ...
    <option value="">Sub Customer</option>
                        ...
                        <input type="text" id="filerType" name="filerType" class="form-control" placeholder="Filer Type">
                    </div>
            ...
            <div class="d-flex justify-content-between p-3 border-bottom">
                <div style="min-width: 350px;">
                    ...
                    <div class="d-flex align-items-center mb-1">
                        ...
                        <input type="text"
                            class="form-control text-end fw-bold text-primary bg-info-subtle border-primary" value="0">
                    </div>
                    <div class="d-flex align-items-center mb-1">
                        <label class="form-label fw-bold me-2">Advance Tax:</label>
                        <input type="text" class="form-control text-end me-2" style="width: 70px;" value="0.00">
                ...
                <div class="flex-grow-1 ms-3">
                    <div class="d-flex justify-content-end align-items-center mb-1">
                        ...
                        <input type="text" class="form-control text-end me-2" style="width: 70px;" value="0" name="subTotal1" id="subTotal1" >
                        <input type="text" class="form-control text-end me-2" style="width: 70px;" value="0" name="subTotal2" id="subTotal2">
                        <input type="text" class="form-control text-end fw-bold text-primary" style="width: 150px;"
                            value="0">
                    </div>
                    <div class="d-flex justify-content-end align-items-center mb-1">
                        <label class="form-label me-2">Discount:</label>
                        <input type="text" class="form-control text-end me-2" style="width: 120px;" value="" name="discountPercent" id="discountPercent" >
                        <input type="text" class="form-control text-end" style="width: 150px;" value="0" >
                    </div>
                    <div class="d-flex justify-content-end align-items-center mb-1">
                        <label class="form-label me-2">Discount Rs:</label>
                        <input type="text" class="form-control text-end" style="width: 150px;" value="" name="discountAmount" id="discountAmount" >
                    </div>
                    <div class="d-flex justify-content-end align-items-center mb-1">
                    ...
                    <div class="d-flex justify-content-end align-items-center mb-1">
                        ...
                        <input type="text" class="form-control text-end me-2" style="width: 90px;" name="receipt1" value="0" id="receipt1">
                        <input type="text" class="form-control text-end" style="width: 70px;" value="0" name="receipt2" id="receipt2">
                    </div>
                    <div class="d-flex justify-content-end align-items-center mb-1">
                        <label class="form-label me-2">Final Balance:</label>
                        <input type="text" class="form-control text-end me-2" style="width: 150px;" value="0" name="finalBalance1" id="finalBalance1">
                        <input type="text" class="form-control text-end" style="width: 150px;" value="0" name="finalBalance2" id="finalBalance2">
                    </div>
                    <div class="form-group">
                        <label for="weight">Total Weight (kg)</label>
                        <input type="number" name="weight" class="form-control" step="0.01" placeholder="Enter total weight">
                    </div>
        ...
        if (id) {
            $.get('{{ url("/get-customer") }}/' + id, function (data) {
                ...
                if (data.customer_type) {
                    $customerType.append('<option value="' + data.customer_type + '" selected>' + data.customer_type + '</option>');
                }
...
$(document).on('input', '.sales-price, .sales-qty, .discount-percent, .discount-amount, #previousBalance, #discountPercent, #receipt1, #receipt2', function() {
    calculateTotals();
});
