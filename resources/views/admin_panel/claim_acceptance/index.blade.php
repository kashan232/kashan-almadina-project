...
<style>
    ...
    #acceptanceTable thead th { white-space: nowrap; background-color: #f8f9fa; color: #333; font-weight: 600; vertical-align: middle; font-size: 13px; }
    #acceptanceTable tbody td { white-space: nowrap; vertical-align: middle; font-size: 13px; }
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-3">
                            <form action="{{ route('claim-acceptance.index') }}" method="GET" class="row g-3 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('claim-acceptance.index') }}" class="btn btn-outline-secondary btn-sm px-4 rounded-pill">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center py-3">
                            <h4 class="card-title mb-0 fw-bold text-dark">Claim Acceptance Management</h4>
                            <a class="btn btn-success btn-sm px-4 rounded-pill" href="{{ route('claim-acceptance.create') }}">
                                <i class="fa fa-plus me-1"></i> New Claim Acceptance
                            </a>
                        </div>
                                                ...
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if($v->status != 'Posted')
                                                        <form action="{{ route('claim-acceptance.post', $v->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="btn btn-outline-primary btn-sm rounded-pill" onclick="return confirm('Post this acceptance?')">
                                                                Post
                                                            </button>
                                                        </form>
                                                        <a href="{{ route('claim-acceptance.edit', $v->id) }}" class="btn btn-outline-warning btn-sm rounded-circle">
