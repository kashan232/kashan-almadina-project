        ...
        <div class="container-fluid pt-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 bg-light p-2 rounded shadow-sm">
                ...
                <div class="d-flex align-items-center gap-2 justify-content-center flex-grow-1">
                    ...
                    <span id="statusBadge" class="badge @if($claim->status === 'Posted') bg-success @else bg-info @endif text-white px-3 py-2 rounded-pill shadow-sm" style="font-size:12px;">
                        <i class="fa @if($claim->status === 'Posted') fa-check @else fa-pencil @endif me-1"></i> {{ $claim->status }}
                    </span>
            ...
            <form action="#" method="POST" id="claimForm" class="position-relative @if($claim->status === 'Posted') form-locked @endif">
                @csrf
                <input type="hidden" name="id" id="claim_id" value="{{ $claim->id }}">
                <input type="hidden" name="action" id="formAction" value="save">
                <div class="posted-watermark @if($claim->status === 'Posted') show @endif" id="postedWatermark">Posted</div>
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" name="entry_date" class="form-control input-sm" value="{{ $claim->entry_date ?? $claim->claim_date }}" required>
                            </div>
                            <div class="col-md-1">
                                <label class="form-label">Entry Time</label>
                                <input type="time" name="entry_time" class="form-control input-sm" value="{{ $claim->entry_time ?? date('H:i') }}" required>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="party_id" id="party_id" class="form-select select2" required data-selected="{{ $claim->party_id }}">
                            ...
                            <div class="col-md-2 mt-1">
                                ...
                                <input type="number" name="sales_price" id="sales_price" class="form-control input-sm text-end fw-bold text-danger" placeholder="0.00" value="{{ $claim->sales_price }}" readonly>
                            </div>
                            <div class="col-md-2 mt-1">
                    ...
                    <div class="card-body py-2">
                        <div class="row g-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="replacement_sales_price" id="replacement_sales_price" class="form-control input-sm text-end fw-bold" placeholder="0.00" value="{{ $claim->replacement_sales_price }}" readonly>
                            </div>
                            <div class="col-md-2">
                                <label class="form-label border-danger border-bottom">Deliver From</label>
                ...
                <div class="card shadow-sm">
                    <div class="card-footer bg-white py-3">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="{{ route('customer-claims.create') }}" id="newBtn" class="btn btn-sm btn-info rounded-pill px-4 shadow-sm text-white">
...
$(document).ready(function() {
    ...
    $('#party_type').on('change', function() {
        var type = $(this).val();
        var selectedId = $('#party_id').data('selected');
        ...
        $.get("{{ route('stock-holds.party.list') }}", { type: type }, function(res) {
            ...
            if(isInitialLoad && selectedId) {
                $p.val(selectedId).trigger('change.select2');
                $('#party_code_input').val(selectedId);
                isInitialLoad = false;
            } else {
                $p.trigger('change');
            }
