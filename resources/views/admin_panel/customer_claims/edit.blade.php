                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-2 mt-1">
                                ...
                                <input type="number" name="sales_price" id="sales_price" class="form-control input-sm text-end fw-bold text-danger" placeholder="0.00" readonly value="{{ $claim->sales_price }}">
                            </div>
                            <div class="col-md-2 mt-1">
                    ...
                    <div class="card-body py-2">
                        <div class="row g-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="replacement_sales_price" id="replacement_sales_price" class="form-control input-sm text-end fw-bold" placeholder="0.00" readonly value="{{ $claim->replacement_sales_price }}">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label border-danger border-bottom">Deliver From</label>
