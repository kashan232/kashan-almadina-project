    ...
    <div class="main-content-inner">
        <div class="container-fluid stock-hold-page">
            ...
            <div class="d-flex justify-content-between align-items-center page-top-bar bg-light rounded shadow-sm">
                <div class="d-flex align-items-center gap-2" style="min-width:180px;">
                    <span class="badge bg-secondary px-2 py-1 rounded" style="font-size:11px;">
                        <i class="fa fa-clock-o me-1"></i> {{ $claim->entry_time ? \Carbon\Carbon::parse($claim->entry_time)->format('h:i A') : date('h:i A') }}
                    </span>
                </div>
            ...
            <form action="#" method="POST" id="claimForm" class="position-relative {{ $claim->status == 'Posted' ? 'form-locked' : '' }}">
                ...
                <input type="hidden" name="entry_time" value="{{ $claim->entry_time ? \Carbon\Carbon::parse($claim->entry_time)->format('H:i') : date('H:i') }}">
