                ...
                <div class="row g-2 align-items-end mb-4">
                    ...
                    <div class="col-md-5">
                        <div class="d-flex gap-1 justify-content-end mb-1">
                            ...
                            <a href="{{ $receipt->id ? route('ExpenseVoucher.print', $receipt->id) : 'javascript:void(0)' }}" id="previewPrintBtn" target="_blank" class="btn btn-outline-dark btn-sm rounded-pill px-3 shadow-sm {{ !$receipt->id ? 'disabled' : '' }}" style="font-size: 11px;">
                                <i class="fa fa-print"></i> Print
                            </a>
                            <a href="{{ route('expense-vochers') }}" class="btn btn-info btn-sm text-dark fw-bold rounded-pill px-3 shadow-sm" style="font-size: 11px;">
