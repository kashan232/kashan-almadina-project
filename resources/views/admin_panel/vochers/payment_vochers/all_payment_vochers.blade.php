                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-2">
                            <form action="{{ route('all-Payment-vochers') }}" method="GET" class="row g-2 align-items-center">
                                <div class="col-md-3">
                                    <h6 class="mb-0 fw-bold text-dark ms-2"><i class="fa fa-credit-card me-2 text-primary"></i>Payment Vouchers</h6>
                                </div>
                                <div class="col-md-3">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center py-2 border-bottom">
                            <span class="fw-bold text-muted small text-uppercase">Payments Registry</span>
                                ...
                                <table id="example" class="table table-sm table-striped table-bordered w-100 mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center small">PV</td>
                                            <td class="fw-bold text-primary">{{ (int) preg_replace('/[^0-9]/', '', substr($item->pvid, strlen('PVID-'))) }}</td>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if($item->status === 'draft' || $item->status === 'unposted' || empty($item->status))
                                                        ...
                                                        <a href="{{ route('Payment-vochers', $item->id) }}" class="btn btn-outline-warning btn-xs px-1 py-0" title="Edit" style="height: 20px;">
                                                    ...
                                                    <a href="{{ route('PaymentVoucher.print', $item->id) }}" target="_blank" class="btn btn-outline-dark btn-xs px-1 py-0" title="Print" style="height: 20px;">
...
<script>
    $(document).ready(function() {
        ...
        const storageKey = 'payment_voucher_table_columns_v2';
