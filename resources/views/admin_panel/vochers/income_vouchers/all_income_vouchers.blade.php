                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-3">
                            <form action="{{ route('all-income-vochers') }}" method="GET" class="row g-3 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('all-income-vochers') }}" class="btn btn-outline-secondary btn-sm px-4 rounded-pill">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0 fw-bold text-dark"><i class="fa fa-line-chart me-2 text-success"></i>Income Vouchers</h4>
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-success btn-sm px-4 rounded-pill shadow-sm" href="{{ route('income-vochers') }}">
                                    <i class="fa fa-plus me-1"></i> Add Income Voucher
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-3">
                            <div class="table-responsive">
                                <table id="incomeTable" class="table table-hover table-striped table-bordered display w-100">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Type</th>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if($item->status === 'draft' || $item->status === 'Unposted' || $item->status === 'unposted')
                                                        ...
                                                        <a href="{{ route('income-vochers', $item->id) }}" class="btn btn-outline-warning btn-sm rounded-circle" title="Edit">
                                                    ...
                                                    <a href="{{ route('incomeVoucher.print', $item->id) }}" target="_blank" class="btn btn-outline-dark btn-sm rounded-circle" title="Print">
...
$(document).ready(function() {
    ...
    const storageKey = 'income_voucher_table_columns_v2';
