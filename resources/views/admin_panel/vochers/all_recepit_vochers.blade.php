                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-3">
                            <form action="{{ route('all-recepit-vochers') }}" method="GET" class="row g-3 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('all-recepit-vochers') }}" class="btn btn-outline-secondary btn-sm px-4 rounded-pill">
                ...
                <div class="col-12">
                    <div class="card border-0">
                        <div class="card-header d-flex justify-content-between align-items-center py-3">
                            <h4 class="card-title mb-0 fw-bold text-dark">Receipts Vouchers</h4>
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-primary btn-sm px-4 rounded-pill" href="{{ route('recepit-vochers') }}">
                                    <i class="fa fa-plus me-1"></i> Add Receipt Voucher
                                </a>
                            </div>
                        </div>
                                ...
                                <table id="example" class="table table-striped table-bordered display w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>RV</td>
                                            <td class="fw-bold">{{ (int) preg_replace('/[^0-9]/', '', substr($item->rvid, strlen('RVID-'))) }}</td>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if($item->status === 'draft' || $item->status === 'Unposted')
                                                        ...
                                                        <a href="{{ route('recepit-vochers', $item->id) }}" class="btn btn-outline-warning btn-sm rounded-circle" title="Edit">
...
<script>
    $(document).ready(function() {
        ...
        const storageKey = 'receipt_voucher_table_columns_v1';
    ...
    $(document).on('submit', 'form.d-inline[method="POST"]', function(e) {
        // If it's a delete or post form, common handling if needed
    });
</script>
@endsection