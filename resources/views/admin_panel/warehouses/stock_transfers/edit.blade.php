        ...
        <div class="container-fluid pt-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 bg-light p-2 rounded shadow-sm">
                ...
                <div class="d-flex align-items-center gap-2 justify-content-center flex-grow-1">
                    <h6 class="page-title mb-0 fw-bold">Edit Stock Transfer (#{{ $transfer->id }})</h6>
                    <span id="statusBadge" class="badge bg-info text-dark px-3 py-2 rounded-pill shadow-sm" style="font-size:12px;">
            ...
            <form action="{{ route('stock_transfers.update', $transfer->id) }}" method="POST" id="transferForm">
                @csrf
                @method('PUT')
...
$(document).ready(function() {
    ...
    function ajaxSaveDraft(callback) {
        ...
        $.ajax({
            url: "{{ route('stock_transfers.update', $transfer->id) }}",
            type: 'POST',
            data: $form.serialize(),
            ...
            success: function(res) {
                if (res.success) {
                    ...
                    $('.page-title').text('Edit Stock Transfer (#' + res.id + ')');
...
// print preview button remains unchanged
            ...
            complete: function() {
                $('#saveDraftBtn').prop('disabled', false)
                    .html('<i class="fa fa-floppy-o me-1"></i> Update <kbd style="font-size:9px;opacity:.8;margin-left:4px;">Ctrl+S</kbd>');
            }
        });
    }
