    ...
    <div class="container-fluid p-3">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 border-bottom-0 d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fw-bold" style="color: #0d47a1;">Goods Transfer Report Filters</h4>
            ...
            <div class="card-body pt-0">
                <form action="{{ route('reports.stock-transfer.preview') }}" method="POST" id="reportForm">
                    @csrf
                    ...
                    <div class="filter-grid-container">
                        <div class="row g-1 mb-3">
                            ...
                            <div class="col-md-1" style="min-width: 110px;">
                                <div class="filter-column">
                                    <div class="filter-header">
                                        <input type="checkbox" class="select-all" data-target="from-list"> From
                                    </div>
                                    <div class="filter-list" id="from-list">
                                        <div class="filter-item">
                                            <input type="checkbox" name="from_warehouse[]" value="shop">
                                            <span>Shop</span>
                                        </div>
                                        @foreach($warehouses as $w)
                                            <div class="filter-item" data-groups="{{ is_array($w->user_group_ids) ? implode(',', $w->user_group_ids) : '' }}">
                                                <input type="checkbox" name="from_warehouse[]" value="{{ $w->id }}">
                            ...
                            <div class="col-md-1" style="min-width: 110px;">
                                <div class="filter-column">
                                    <div class="filter-header">
                                        <input type="checkbox" class="select-all" data-target="to-list"> To
                                    </div>
                                    <div class="filter-list" id="to-list">
                                        <div class="filter-item">
                                            <input type="checkbox" name="to_warehouse[]" value="shop">
                                            <span>Shop</span>
                                        </div>
                                        @foreach($warehouses as $w)
                                            <div class="filter-item" data-groups="{{ is_array($w->user_group_ids) ? implode(',', $w->user_group_ids) : '' }}">
                                                <input type="checkbox" name="to_warehouse[]" value="{{ $w->id }}">
                                                <span>{{ $w->warehouse_name }}</span>
                                            </div>
                                        @endforeach
                                    </div>
                    ...
                    <div class="card border border-primary mb-3 shadow-sm">
                        ...
                        <div class="card-body p-2">
                            <div class="row g-2 align-items-end">
                                <div class="col-md-2">
                                    <label class="fw-bold mb-1" style="font-size: 11px;">Trn ID</label>
                                    <input type="text" name="transfer_id" class="form-control form-control-sm" placeholder="5062..." style="height: 30px; font-size: 12px;">
                                </div>
                                <div class="col-md-2">
    ...
    $(document).ready(function() {
        ...
        function filterByGroup() {
            ...
            if (selectedGroups.length === 0) {
                $('#officer-list .filter-item, #from-list .filter-item, #to-list .filter-item').show();
                return;
            }
            ['officer-list', 'from-list', 'to-list'].forEach(function(listId) {
