    ...
    <div class="container-fluid p-3">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 border-bottom-0 d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fw-bold" style="color: #0d47a1;">Claim Receipt / Credit Report Filters</h4>
            ...
            <div class="card-body pt-0">
                <form action="{{ route('reports.claim-item-receipt.preview') }}" method="POST" id="reportForm">
                    @csrf
                    ...
                    <div class="filter-grid-container">
                        <div class="row g-1 mb-3">
                            ...
                            <div class="col-md-1" style="min-width: 110px;">
                                <div class="filter-column">
                                    <div class="filter-header">
                                        <input type="checkbox" class="select-all" data-target="deductfrom-list"> Deduct From
                                    </div>
                                    <div class="filter-list" id="deductfrom-list">
                                        @foreach($deductFromWarehouses as $w)
                            ...
                            <div class="col-md-1" style="min-width: 110px;">
                                <div class="filter-column">
                                    <div class="filter-header">
                                        <input type="checkbox" class="select-all" data-target="addto-list"> Add To
                                    </div>
                                    <div class="filter-list" id="addto-list">
                                        <div class="filter-item">
                                            <input type="checkbox" name="to_warehouse[]" value="0">
                                            <span>Shop Stock</span>
                                        </div>
                                        @foreach($addToWarehouses as $w)
                                            <div class="filter-item" data-groups="{{ is_array($w->user_group_ids) ? implode(',', $w->user_group_ids) : '' }}">
