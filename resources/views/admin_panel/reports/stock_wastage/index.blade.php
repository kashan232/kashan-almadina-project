    ...
    <div class="container-fluid p-3">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 border-bottom-0 d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fw-bold" style="color: #0d47a1;">Goods Wastage Report Filters</h4>
            ...
            <div class="card-body pt-0">
                <form action="{{ route('reports.stock-wastage.preview') }}" method="POST" id="reportForm">
                    @csrf
                    ...
                    <div class="filter-grid-container">
                        <div class="row g-1 mb-3">
                            ...
                            <div class="col-md-1" style="min-width: 110px;">
                                <div class="filter-column">
                                    <div class="filter-header">
                                        <input type="checkbox" class="select-all" data-target="head-list"> Exp Head
                                    </div>
                            ...
                            <div class="col-md-2" style="min-width: 130px;">
                                <div class="filter-column">
                                    <div class="filter-header">
                                        <input type="checkbox" class="select-all" data-target="account-list"> Exp A/C
                                    </div>
                                    <div class="p-1 bg-light border-bottom">
                                    ...
                                    <div class="filter-list" id="account-list">
                                        @foreach($accounts as $acc)
                                            <div class="filter-item" data-search="{{ strtolower($acc->title) }}">
                    ...
                    <div class="card border border-primary mb-3 shadow-sm">
                        ...
                        <div class="card-body p-2">
                            <div class="row g-2 align-items-end">
                                <div class="col-md-2">
                                    <label class="fw-bold mb-1" style="font-size: 11px;">WST ID</label>
                                    <input type="text" name="gwn_id" class="form-control form-control-sm" placeholder="813..." style="height: 30px; font-size: 12px;">
                                </div>
                                <div class="col-md-2">
...
<style>
    ...
    #itemSearch, #accountSearch { height: 24px; font-size: 11px; }
</style>
@endsection
    ...
    $(document).ready(function() {
        ...
        function filterByGroup() {
            ...
            if (selectedGroups.length === 0) {
                $('#officer-list .filter-item, #warehouse-list .filter-item').show();
                return;
            }
            ['officer-list', 'warehouse-list'].forEach(function(listId) {
