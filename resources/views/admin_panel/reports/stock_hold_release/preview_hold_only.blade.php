...
<body>
    ...
    <div class="report-header">
        <div class="report-title">Stock Hold Report</div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 12%;">Hold ID</th>
                    <th style="width: 15%;">Hold Date</th>
            ...
            <tbody>
                @foreach($party['rows'] as $r)
                    <tr>
                        ...
                        <td class="center">{{ $r['hold_date'] }}</td>
    ...
    @empty
        <p class="empty-msg">No stock hold records found for selected filters.</p>
    @endforelse
</body>
</html>
