...
<head>
    <meta charset="UTF-8">
    <title>Income Voucher Report</title>
    @include('admin_panel.reports.partials.voucher_preview_styles')
</head>
<body>
@php
    $isDestAccount = ($report_type ?? 'destination_account') === 'destination_account';
    $extraColLabel = $isDestAccount ? 'Source Party Name' : 'Destination Account';
    $totalCols = 7;
@endphp
@include('admin_panel.reports.partials.voucher_preview_header', [
    'reportTitle' => 'Income Voucher Report',
        ...
        @foreach($grouped as $items)
            ...
            @foreach($items as $line)
                ...
                <tr class="data-row">
                    ...
                    <td class="text-left">{{ $isDestAccount ? $line->party_name : $line->account_name }}</td>
