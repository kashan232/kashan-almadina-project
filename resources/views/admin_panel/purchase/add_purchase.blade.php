        ...
        @if(isset($purchase))
            @php
                $pItems = $purchase->items->map(function($item) {
                    ...
                    $retail = (float) ($item->retail_price > 0 ? $item->retail_price : ($item->purchase_retail_price > 0 ? $item->purchase_retail_price : ($product?->latestPrice?->purchase_retail_price ?? $product?->latestPrice?->sale_retail_price ?? $product?->retail_price ?? 0)));
