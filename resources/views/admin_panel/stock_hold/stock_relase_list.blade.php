                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center py-2 border-bottom">
                            <span class="fw-bold text-muted small text-uppercase">Release Records</span>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table id="stockReleaseTable" class="table table-sm table-striped table-bordered w-100 mb-0">
                                    <thead>
                                        <tr>
                                            <th>Type</th>
                                            <th>Inv#</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if(($v->release_type ?? 'stock') == 'claim')
                                                    <span class="badge bg-info-subtle text-info border border-info px-2 py-0" style="font-size:9px;">Claim Release</span>
                                                @else
                                                    <span class="badge bg-secondary-subtle text-secondary border border-secondary px-2 py-0" style="font-size:9px;">Stock Release</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td class="py-1">
                                                @foreach($v->items as $item)
                                                    <div class="item-detail-row">
                                                        ...
                                                        <span class="text-primary fw-bold ms-1">({{ (float)$item->release_qty }})</span>
                                                    </div>
                                                @endforeach
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if($v->status != 'Posted')
                                                        <form action="{{ route('stock-holds.release.post', $v->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="btn btn-primary btn-xs px-2 py-0" onclick="return confirm('Post this release?')" title="Post now" style="font-size: 10px;">
