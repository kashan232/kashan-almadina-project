                ...
                <div class="col-lg-12 col-md-12 mb-30">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">Add Inward Gatepass</h4>
...
<tr>
    <td>
        <input type="hidden" name="product_id[]" class="product_id">
        <input type="text" class="form-control productSearch" placeholder="Search product..." autocomplete="off">
        <ul class="searchResults list-group mt-1"></ul>
    </td>
    <td>
        <input type="text" name="brand[]" class="form-control" readonly>
    ...
    <td class="text-end">
      ...
      <li class="list-group-item search-result-item"
        ...
        $('#gatepassItems').on('click', '.remove-row', function() {
